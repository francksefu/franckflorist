...
int main()
{
    ...
    cout<<"mais c est mieux de commencer avec le gestionnaire pour aller etape par etape"<<endl;
    cin>>i;
    switch(i){
    case gestionnaire:
        ...
        cout<<"la partie gestionnaire est finie"<<endl;
        cout<<"tapez 1 si vous voulez voir la partie de l application en tant que chauffeur..ou autre une autre touche pour quitter"<<endl;
    ...
    case chauffeur:
        cout<<"Ici nous commencons la partie pour les chauffeurs ,merci de bien vouloir suivre les instructions"<<endl;
        ...
        cout<<"voudriez vous voir la partie de l application en tant qu administrateur?"<<endl;
        ...
        cout<<"le chauffeur2 doit livrer :"<<chauffeur2.fun.getNbreFuneraire()<<" Commande funeraire "<<endl;
        afficherlesHeures(30,30+chauffeur2.fun.getNbreFuneraire(),lesHeures,"funeraille");
        cout<<endl;
        cout<<chauffeur2.ent.getNbreEntreprise()<<" Commande pour entreprise "<<endl;
        afficherlesHeures(40,40+chauffeur2.ent.getNbreEntreprise(),lesHeures,"Entreprise");
        ...
        cout<<"le chauffeur3 doit livrer :"<<chauffeur3.fun.getNbreFuneraire()<<" Commande funeraire, "<<endl;
         afficherlesHeures(60,60+chauffeur3.fun.getNbreFuneraire(),lesHeures,"funeraire");
         cout<<endl;
        cout<<chauffeur3.ent.getNbreEntreprise()<<"Commande pour entreprise, "<<endl;
        afficherlesHeures(70,70+chauffeur3.ent.getNbreEntreprise(),lesHeures,"Entreprise");
        ...
        cout<<endl;cout<<endl;
         ...
         cout<<"le chauffeur4 doit livrer :"<<chauffeur4.fun.getNbreFuneraire()<<" Commande funeraire "<<endl;
         afficherlesHeures(90,90+chauffeur4.fun.getNbreFuneraire(),lesHeures,"Funeraire");
         cout<<endl;
        cout<<chauffeur4.ent.getNbreEntreprise()<<" Commande pour entreprise,"<<endl;
        afficherlesHeures(100,100+chauffeur4.ent.getNbreEntreprise(),lesHeures,"entreprises");
        ...
        cout<<endl;cout<<endl;
         ...
         cout<<"le chauffeur5 doit livrer : "<<chauffeur5.fun.getNbreFuneraire()<<" Commande funeraire, "<<endl;
         afficherlesHeures(120,120+chauffeur5.fun.getNbreFuneraire(),lesHeures,"Funeraire");
         cout<<endl;
        cout<<chauffeur5.ent.getNbreEntreprise()<<"Commande pour entreprise, "<<endl;
        afficherlesHeures(130,130+chauffeur5.ent.getNbreEntreprise(),lesHeures,"Entreprise");
